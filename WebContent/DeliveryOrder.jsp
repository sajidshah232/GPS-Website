...
<%
    ...
    ResultSet rs = st.executeQuery("SELECT * FROM cust_address where userid='"+session.getAttribute("userid")+"'");
    if(rs.next()){
...
%>
<button class="btn btn-primary mt-2 btn-sm float-right" onclick="document.getElementById('address').removeAttribute('disabled')">Change Address</button>
<% } %>
